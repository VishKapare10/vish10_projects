...
public class UserHistory extends AppCompatActivity {
    ...
    //String url="http://192.168.0.130/disease_prediction/userhistory.php";
    String url="http://sourcecodetechnology.com/disease_prediction/userhistory.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferenceManager=new SharedPreferenceManager(UserHistory.this);
